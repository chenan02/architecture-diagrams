...
{
  var input = document.getElementsByName("warmwater")[0];
  input.innerHTML = dWarmwaterheating;
}; /* setInputFields */
...
//  var select = document.getElementsByName("warmwater")[0];
//  select.focus();
...
----------------------------------------------------------------------*/
function selectWW(button,index)
{
  //var parent = button.parentNode;
  var aInput = document.getElementsByTagName("label")[0];
  document.getElementsByName("warmwater1")[0].value = index;
