...
Version    : $Id: wtown.js 2337 2012-09-20 15:14:54Z hartwig $
...
function setInputFields()
  {
	...
	drawPerMonth("permonth",adMonthHeating,adMonthCooling,
	 ...
	 var input = document.getElementsByName("windowEastP")[0];
	 input.value = dWindowEastP.toFixed(2);
...
Initializes wtows.xhtml
 ---------------------------------------------------------------------*/
  function onLoad()
  {
    ...
    var select = document.getElementsByName("windowEastP")[0];
    select.focus();  
  }; /* onLoad */
...
{
  var bValid = false;
  var dPercentage = percentNumber("windowEastP",MESSAGES.percentage_numeric,MESSAGES.percentage_bounds);
  if (dPercentage != null)
    bValid = true;
  return bValid;
}; /* validate */
