...
function setInputFields()
  {
	...
	drawPerMonth("permonth",adMonthHeating,adMonthCooling,
	 ...
	 var input = document.getElementsByName("shadingW")[0];
	 input.value = dShadingW.toFixed(2);
...
function onLoad()
{
  ...
  var select = document.getElementsByName("shadingW")[0];
  select.focus();
}; /* onLoad */
...
{
  var bValid = false;
  var dShadingW = nonnegativeNumber("shadingW",MESSAGES.shading_numeric,MESSAGES.shading_non_negative);
  if (dShadingW != null)
  {
    bValid = true;
  }
